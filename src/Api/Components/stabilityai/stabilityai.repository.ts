import Stabilityai, { StabilityaiModal } from './stabilityai.entity';
import Repository from '../../../repository/repository';
import { injectable } from 'inversify';
import { DatabaseId } from '../../../../types';
import IStabilityaiRepository from './istabilityai.repository';


@injectable()
export default class StabilityaiRepository extends Repository<Stabilityai> implements IStabilityaiRepository {
  model = StabilityaiModal
