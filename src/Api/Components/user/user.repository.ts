...
export default class UserRepository extends Repository<User> implements IUserRepository {
  ...
  updateSkills(_id: string, user: User): Promise<any> {
  ...
  updateDescription(_id: string, user: User): Promise<any> {
    user.updatedAt = new Date();
    return this.model
  ...
  updateLifeExperience(_id: string, user: User): Promise<any> {
    user.updatedAt = new Date();
    return this.model
  ...
  updateCultureGoup(_id: string, user: User): Promise<any> {
    user.updatedAt = new Date();
    return this.model
  ...
  updateBio(_id: string, user: User): Promise<any> {
    user.updatedAt = new Date();
    return this.model
      .findByIdAndUpdate(_id, { $set: { bio: user.bio } }, { new: true, runValidators: true })
      .populate({
  ...
  updateMentorshipStatus(_id: string, user: User): Promise<any> {
    user.updatedAt = new Date();
    return this.model
  ...
  getFollowing(user: User): Promise<any> {
    return this.model
